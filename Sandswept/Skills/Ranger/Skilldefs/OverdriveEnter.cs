...
namespace Sandswept.Skills.Ranger.Skilldefs
{
    public class OverdriveEnter : SkillBase<OverdriveEnter>
    {
        ...
        public override string Description => "$suAgile$se. Transform your rifle into a $sdrapid-fire machine gun$se and fire a rapid stream of $sdbullets$se for $sd200% damage$se. $srContinous fire will cause overheating, increasing spread, ignite chance and damaging you.$se".AutoFormat();
