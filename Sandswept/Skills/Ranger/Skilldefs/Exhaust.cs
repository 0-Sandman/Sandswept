...
namespace Sandswept.Skills.Ranger.Skilldefs
{
    public class Exhaust : SkillBase<Exhaust>
    {
        ...
        public override string Description => "Fire a piercing blast for every $sr20%$se of $srheat$se that deals $sd300% damage$se and releases a delayed explosion that deals $sd200%$se damage and $ignites$se.".AutoFormat();
