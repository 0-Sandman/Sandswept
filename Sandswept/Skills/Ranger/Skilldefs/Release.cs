...
namespace Sandswept.Skills.Ranger.Skilldefs
{
    public class Release : SkillBase<Release>
    {
        ...
        public override string Description => "$rcLose all Charge$ec. Fire a piercing blast for $sd500% damage$se, plus an additional $sd100%$se for every stack of $rcCharge$ec.".AutoFormat();
