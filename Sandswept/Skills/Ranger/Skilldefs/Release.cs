...
namespace Sandswept.Skills.Ranger.Skilldefs
{
    public class Release : SkillBase<Release>
    {
        ...
        public override string Description => "$srLose all Charge$se. Fire a piercing blast for $sd500% damage$se and an additional $sd100%$se for every $rcCharge$ec lost.".AutoFormat();
