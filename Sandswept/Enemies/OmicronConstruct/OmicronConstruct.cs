...
{
    [ConfigSection("Enemies :: Omicron Construct")]
    public class OmicronConstruct : EnemyBase<OmicronConstruct>
    {
        [ConfigField("Director Credit Cost", "", 500)]
        ...
        public override void Modify()
        {
            ...
            body.baseNameToken.Add("Omicron Construct");
