...
namespace Sandswept.Items.Greens
{
    ...
    public class CrownsDiamond : ItemBase<CrownsDiamond>
    {
        ...
        public override string ItemFullDescription => $"Being out of danger grants $sh{barrierGain * 100f}%$se of $shmaximum health$se as $shbarrier$se. $shBarrier$se decays $su{baseBarrierDecayReduction * 100f}%$se $ss(+{stackBarrierDecayReduction * 100f}% per stack)$se $suslower$se while out of combat or danger.".AutoFormat();
