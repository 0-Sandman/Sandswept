...
namespace Sandswept.Survivors.Renegade.States {
    public class CrushAerial : BaseSkillState {
        ...
        public override void OnEnter()
        {
            ...
            dir = base.inputBank.aimDirection * velocity;
        ...
        public override void FixedUpdate()
        {
            ...
            if ((impacted || base.characterMotor.Motor.GroundingStatus.IsStableOnGround)) {
                OnImpact();
        ...
        public void OnImpact() {
            ...
            attack.AddModdedDamageType(Renegade.GravSlam);
            ...
            if (combo.HitTargets(boxes.ToArray())) {
                combo.UpdateCombo(DamageSource.Special);
            }
