...
namespace Sandswept.Survivors
{
    public class Ranger : SurvivorBase<Ranger>
    {
        ...
        public override string Failure => "...and so she didn't leave lmao skill issue btw you should listen to Unprocessed - In Concretion, Unprocessed - Perception, Unprocessed - Covenant, Periphery - Periphery 1, Periphery - Periphery 2";
