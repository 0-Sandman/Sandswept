...
namespace Sandswept.Survivors.Ranger.Skilldefs
{
    public class HeatSignature : SkillBase<HeatSignature>
    {
        ...
        public override string Description => "$suAgile$se. $sdStunning$se. $suSidestep$se a very short distance and deal $sd350% damage$se. Hitting enemies generates $r3 Charge$ec.".AutoFormat();
