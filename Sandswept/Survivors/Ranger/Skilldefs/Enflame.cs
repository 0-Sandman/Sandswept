...
namespace Sandswept.Survivors.Ranger.Skilldefs
{
    public class Enflame : SkillBase<Enflame>
    {
        ...
        public override string Description => "$suAgile$se. Fire a rapid stream of bullets for $sd120% damage$se. $srHeat increases spread and ignite chance$se.".AutoFormat();
