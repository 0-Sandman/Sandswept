...
namespace Sandswept.Survivors.Ranger
{
    public class Ranger : SurvivorBase<Ranger>
    {
        ...
        public override void LoadAssets()
        {
            ...
            "SS_RANGER_PASSIVE_DESC".Add("Hold up to " + Projectiles.DirectCurrent.maxCharge + " $rcCharge$ec. Each $rcCharge$ec increases $shbase health regeneration$se by $sh0.25 hp/s$se and $sharmor$se by $sh1.5$se. $rcCharge decays over time$ec.".AutoFormat());
