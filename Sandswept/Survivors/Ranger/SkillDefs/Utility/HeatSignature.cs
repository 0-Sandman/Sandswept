namespace Sandswept.Survivors.Ranger.SkillDefs.Utility
{
    public class HeatSignature : SkillBase<HeatSignature>
    {
        ...
        public override string Description => "$suAgile$se. $sdStunning$se. $suSidestep$se a very short distance and deal $sd250% damage$se. Hitting enemies generates $rc3 Charge$ec and $sdextends$se the dash.".AutoFormat();
