...
namespace Sandswept.Survivors.Ranger.SkillDefs.Primary
{
    public class DirectCurrent : SkillBase<DirectCurrent>
    {
        ...
        public override string Description => "Fire an arcing electric current for $sd100-350% damage$se. Hitting enemies generates $rc1 Charge$ec. <style=cIsUtility>Damage and blast radius ramp up with distance.</style>".AutoFormat();
