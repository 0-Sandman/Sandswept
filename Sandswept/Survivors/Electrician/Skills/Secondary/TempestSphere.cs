...
namespace Sandswept.Survivors.Electrician.Skills
{
    public class TempestSphere : SkillBase<TempestSphere>
    {
        ...
        public override string Description => "Send forth an orb of energy that <style=cIsDamage>damages</style> targets within for <style=cIsDamage>330% damage per second</style>. <style=cIsUtility>Release to lock the orb in place</style>.";
