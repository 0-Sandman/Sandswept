...
namespace Sandswept.Survivors.Electrician.Skills
{
    public class GalvanicBolt : SkillBase<GalvanicBolt>
    {
        ...
        public override string Description => "Blast out a galvanic ball that <style=cIsUtility>sticks</style> into terrain, zapping nearby enemies for <style=cIsDamage>100% damage</style> periodically. <style=cIsDamage>Explodes</style> for <style=cIsDamage>400% damage</style> on impact.";
