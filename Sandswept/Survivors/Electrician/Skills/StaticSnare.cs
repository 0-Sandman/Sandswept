...
namespace Sandswept.Survivors.Electrician.Skills
{
    public class StaticSnare : SkillBase<StaticSnare>
    {
        ...
        public override string Description => "<style=cIsUtility>Lightweight.</style> Deploy a pylon that zaps targets for <style=cIsDamage>300% damage</style>, and damages targets between you and it for <style=cIsDamage>200% damage per second</style>. Re-activate to zip to the pylon for <style=cIsDamage>800% damage</style>. Hold to manually detonate the pylon.";
