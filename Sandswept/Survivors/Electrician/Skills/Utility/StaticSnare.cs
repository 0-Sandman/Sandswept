...
namespace Sandswept.Survivors.Electrician.Skills
{
    public class StaticSnare : SkillBase<StaticSnare>
    {
        ...
        public override string Description => "<style=cIsUtility>Lightweight.</style> Deploy a pylon that <style=cIsDamage>zaps</style> targets for <style=cIsDamage>300% damage</style>, and damages targets between you and it for <style=cIsDamage>300% damage per second</style>. Reactivate to <style=cIsUtility>zip</style> to the pylon for <style=cIsDamage>800% damage</style>. <style=cIsUtility>Hold to manually detonate the pylon.</style>";
